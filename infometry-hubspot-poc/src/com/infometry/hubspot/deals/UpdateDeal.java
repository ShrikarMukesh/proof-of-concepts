...
public class UpdateDeal {
	...
	public static void main(String[] args) throws Exception {
		...
		prop.put("amount", "300");
		prop.put("closedate", "2020-08-23");
		prop.put("dealtype", "newbusiness");
		prop.put("dealname", "first_deal");
		...
		WebResource webResource =client.resource("https://api.hubapi.com/crm/v3/objects/deals/2795720242");
