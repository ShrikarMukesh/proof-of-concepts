...
public class UpdateCompany {
	...
	public static void main(String[] args) throws Exception {
		...
		prop.put("city", "bengaluru");
		prop.put("country", "India");
		prop.put("description", "business intelligence");
		prop.put("industry", "java");
		...
		WebResource webResource =client.resource("https://api.hubapi.com/crm/v3/objects/companies/4319700327");
