...
public class UpdateComment {
	private static final String APPLICATION_NAME = "Update Comment";
			...
			if(fileId != null){
				...
				for(Comment comment : commentsList){
					if(comment.getContent().equals("Nice Pic")){
						...
						content.setContent("Superb");
						comments.update(fileId, comment.getId(), content).setFields("content").execute();
						break;
					}
				}
