...
import com.google.api.services.drive.Drive.Teamdrives.Delete;
import com.google.api.services.drive.DriveScopes;
import com.info.drive.credentials.DriveCredential;

public class TeamDrive_Delete {
	...
	public static void main(String []args) throws IOException{
		...
		Delete teamDrive = teamDrives.delete("0AFL0peG5txAOUk9PVA");
		Void teamdrive = teamDrive.execute();
