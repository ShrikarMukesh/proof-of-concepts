...
public class FileUpdate1 {
	...
	public static void main(String []args){
		...
		try{
			...
			File file = new File();
			file.setName("GetPostingTransactionSummaryResult.java");
			//java.io.File fileToLoad = new java.io.File(FileUpdate1.class.getResource("FileUpdate1.class").getPath());
			java.io.File fileToLoad = new java.io.File("C:\\Users\\InfometryPC\\Desktop\\GetPostingTransactionSummaryResult.java");
